...
export default {
  ...
  "zh-cn": {
    ...
    "gui.extension.chroblocks.name": "创智源",
    "gui.extension.chroblocks.name": "创智源",
    "gui.extension.chroblocks.description": "连接我们的物理世界",
    ...
    "chroblocks.motor": "[MOTOR_POS]电机[MOTOR_DIR]转 速度[MOTOR_SPEED]",
    "chroblocks.motorPos.left": "左",
    "chroblocks.motorPos.right": "右",
    "chroblocks.motorDir.forward": "正",
    "chroblocks.motorDir.backward": "反",
    "chroblocks.rockerPos": "摇杆[ROCKER_AXIS]轴位置",
    "chroblocks.rockerPos.up": "上",
    "chroblocks.rockerPos.down": "下",
    "chroblocks.rockerPos.left": "左",
    "chroblocks.rockerPos.right": "右",
    "chroblocks.rockerAxis.x": "X",
    "chroblocks.rockerAxis.y": "Y",
    "chroblocks.setRockerMid": "设置摇杆位置区间: x < [ROCKER_MID_X1] 为左，x > [ROCKER_MID_X2] 为右，y < [ROCKER_MID_Y1] 为下，y > [ROCKER_MID_Y2] 为上",
    "chroblocks.getRockerMid": "摇杆为[ROCKER_POS]的区间",
    "chroblocks.isRockerIn": "摇杆为[ROCKER_POS] ?",
    "chroblocks.isRockerButtonPressed": "摇杆按钮按下 ?",
    "chroblocks.tilt": "陀螺仪[TILT_AXIS]轴角度",
    "chroblocks.loudness": "响度 (分贝)",
    "chroblocks.range": "距离 (厘米)",
    "chroblocks.speaker": "设定音调[SPEAKER_TONE], 选择节拍：[SPEAKER_TIME]",
    "chroblocks.speaker.two": "二",
    "chroblocks.speaker.one": "一",
    "chroblocks.speaker.oneSecond": "二分之一",
    "chroblocks.speaker.oneFourth": "四分之一",
    "chroblocks.tiltAxis.x": "X",
    "chroblocks.tiltAxis.y": "Y",
    "chroblocks.tiltAxis.z": "Z",
    "chroblocks.loudness.db": "分贝",
    "chroblocks.range.cm": "厘米",
    "chroblocks.slider": "滑杆位置 (百分比)",
    "chroblocks.slider.p": "%",
    "chroblocks.rgb": "改变[RGB_LED]号LED颜色 - R[RGB_R], G[RGB_G], B[RGB_B]",
    "chroblocks.rgbColor": "改变[RGB_LED]号LED颜色 - 选择颜色[RGB_COLOR]",
    'chroblocks.rgbLight': '使[RGB_LED]号灯，亮度增加[LIGHT_NUM]',
    "chroblocks.rgbHex": "改变[RGB_LED]号LED颜色 - 输入颜色字符串 #[RGB_HEX]",
    "chroblocks.number.all": "全部",
